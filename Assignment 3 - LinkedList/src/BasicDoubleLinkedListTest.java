...
public class BasicDoubleLinkedListTest {
	...
	public void testIteratorSuccessfulPrevious() throws UnsupportedOperationException {
		...
		linkedCar.addToEnd(d);
		ListIterator<Car> iteratorCar = linkedCar.iterator();
	//	System.out.print(linkedCar.toArrayList());
		assertEquals(true, iteratorCar.hasNext());
		assertEquals(a, iteratorCar.next());
		assertEquals(b, iteratorCar.next());
		assertEquals(c, iteratorCar.next());
	...
	@Test
	public void testIteratorNoSuchElementExceptionNext() throws UnsupportedOperationException {
		linkedCar.addToFront(a);
		linkedCar.addToEnd(d);
		ListIterator<Car> iteratorCar = linkedCar.iterator();		
		assertEquals(true, iteratorCar.hasNext());
	...
	@Test
	public void testIteratorNoSuchElementExceptionPrevious() throws UnsupportedOperationException {
		linkedCar.addToFront(a);
		linkedCar.addToEnd(d);
		ListIterator<Car> iteratorCar = linkedCar.iterator();		
		assertEquals(true, iteratorCar.hasNext());
	...
	@Test
	public void testRetrieveFirstElement() throws UnsupportedOperationException {
		assertEquals(b, linkedCar.getFirst());
		linkedCar.addToFront(a);
		assertEquals(a, linkedCar.getFirst());
	...
	@Test
	public void testRetrieveLastElement() throws UnsupportedOperationException {
		assertEquals(c, linkedCar.getLast());
		linkedCar.addToEnd(d);
		assertEquals(d, linkedCar.getLast());
